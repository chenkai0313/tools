...
export const articles: Article[] = [
  {
    ...
    title: '什么是 JSON？如何格式化 JSON',
    description: 'JSON 基础语法详解，常见错误避坑指南，多种编程语言的 JSON 格式化方法。',
    category: '前端开发',
...
JSON 简单、通用、跨语言，是开发者必须掌握的数据格式。理解它的语法规则和使用场景，能让你在日常开发中更高效地处理数据。配合格式化工具使用，可以显著提升调试体验。`,
  },
  {
    ...
    title: 'Base64 编码原理及使用场景',
    description: 'Base64 编码的工作原理、为什么体积会增加 33%、在前端开发中的常见用途。',
    category: '前端开发',
    categoryKey: 'frontend',
    date: '2026-04-24',
    readTime: 4,
...
Base64 是一个非常实用的编码方案，理解其原理能帮助你在合适场景下正确使用。本站的 Base64 工具支持图片与 Base64 互转，也可以直接生成图片的 Data URL。`,
  },
  {
    ...
    title: 'Cron 表达式详解（附示例）',
    description: 'Cron 表达式语法详解，5位/6位/7位格式区别，常用定时任务表达式对照表，实际编程中的应用示例。',
    category: '运维监控',
    categoryKey: 'devops',
    date: '2026-04-25',
    readTime: 5,
    content: `## 什么是 Cron 表达式？
...
Cron 表达式是定时任务的核心工具，语法简单但功能强大。掌握基本格式和常用模式可以覆盖绝大多数调度需求。记不住的时候，使用在线 Cron 解析工具可以快速验证表达式是否正确。`,
  },
  {
    ...
    title: 'IP 地址基础知识（IPv4/IPv6）',
    description: 'IPv4 地址结构、IPv6 格式与简写规则、私有地址段、CIDR 子网划分入门。',
    category: '运维监控',
    categoryKey: 'devops',
    date: '2026-04-26',
    readTime: 5,
...
IP 地址是网络通信的基础。理解 IPv4 与 IPv6 的区别、CIDR 表示法以及常见地址段，能帮助你在配置服务器、设置防火墙规则、排查网络问题时更加得心应手。`,
  },
  {
    ...
    title: '常见加密算法（MD5/SHA/AES）区别',
    description: 'MD5、SHA、AES 三种算法的本质区别，哈希和加密的不同之处，各自的实际使用场景。',
    category: '安全相关',
...
\`\`\``,
  },
  {
    ...
    description: '从零开始部署 K3s 集群，包含系统初始化、Docker 配置、NFS 存储。',
    category: '运维监控',
    categoryKey: 'devops',
    date: '2026-04-29',
    readTime: 8,
    hot: true,
    content: `记录一下 Ubuntu 上搭 K3s 集群的步骤。三台机器，一个 master 两个 node，带 NFS 存储。
...
DeepSeek 是目前最值得关注的中国 AI 模型之一。其开源策略、低廉的价格和扎实的性能，使其成为开发者在选择 AI 助手时的重要选项。无论你是通过网页版快速体验，还是通过 API 集成到自己的应用中，DeepSeek 都能提供出色的体验。`,
...

  {
    ...
    title: '用了 Typeless 一个月，我彻底离不开它了',
    description: '一个深度用户的真实体验：Typeless 如何改变我的写作习惯，AI 辅助写作的终极形态可能就是这个样子。',
    category: 'AI 相关',
    categoryKey: 'ai',
    date: '2026-05-09',
    readTime: 6,
    hot: true,
    content: `## 我承认，一开始我是拒绝的
...
但如果它让你也"真香"了——记得回来告诉我。`,
  },
  {
    slug: 'obsidian-note-taking-guide',
    title: '用了两年 Obsidian，我再也回不去别的笔记软件了',
    description: '一个 Obsidian 重度用户的真实体验：为什么本地优先、纯 Markdown 的笔记方式让我彻底放弃了 Notion 和 Evernote。',
    category: 'AI 相关',
    categoryKey: 'ai',
    date: '2026-05-09',
    readTime: 8,
    hot: true,
    content: `## 起因：我厌倦了"笔记搬家"
