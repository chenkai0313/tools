...
DeepSeek 是目前最值得关注的中国 AI 模型之一。其开源策略、低廉的价格和扎实的性能，使其成为开发者在选择 AI 助手时的重要选项。无论你是通过网页版快速体验，还是通过 API 集成到自己的应用中，DeepSeek 都能提供出色的体验。`},{slug:"deepseek-coding-tips",title:"DeepSeek 在编程中的应用与实践技巧",description:"如何用 DeepSeek 提升编程效率？代码生成、调试、审查、文档生成等实用技巧汇总。",category:"AI 相关",categoryKey:"ai",date:"2026-05-03",readTime:5,content:`## AI 辅助编程的现状
...
DeepSeek 在编程领域的表现相当出色。无论是日常编码、调试排错还是代码审查，都能提供有效的帮助。合理使用 DeepSeek，可以显著提升开发效率，让开发者将更多精力放在架构设计和业务逻辑上。但要记住，AI 是工具不是替代品，代码质量和安全的责任始终在开发者自己手上。`}];function l({lang:e}){let[s,o]=(0,r.useState)([]),[a,i]=(0,r.useState)(!0),[n,c]=(0,r.useState)(!1),[d,p]=(0,r.useState)(null);return((0,r.useEffect)(()=>{let e=new AbortController;return fetch("https://sitehub.schg.xyz/api/v1/news/list?page=1&page_size=12",{signal:e.signal}).then(e=>e.json()).then(e=>{0===e.code&&e.data?.list&&o(e.data.list),i(!1)}).catch(e=>{"AbortError"!==e.name&&(c(!0),i(!1))}),()=>e.abort()},[]),a)?(0,t.jsx)("div",{className:"grid gap-4 sm:grid-cols-2 lg:grid-cols-3",children:[1,2,3,4,5,6].map(e=>(0,t.jsxs)("div",{className:"animate-pulse rounded-xl border border-white/[0.06] bg-white/[0.03] p-4",children:[(0,t.jsx)("div",{className:"mb-2 h-4 w-3/4 rounded bg-white/[0.06]"}),(0,t.jsx)("div",{className:"mb-3 h-3 w-1/2 rounded bg-white/[0.04]"}),(0,t.jsxs)("div",{className:"space-y-1.5",children:[(0,t.jsx)("div",{className:"h-3 w-full rounded bg-white/[0.04]"}),(0,t.jsx)("div",{className:"h-3 w-5/6 rounded bg-white/[0.04]"})]})]},e))}):n?(0,t.jsx)("div",{className:"flex flex-col items-center justify-center py-16 text-dark-400",children:(0,t.jsx)("p",{className:"text-lg",children:"zh"===e?"资讯加载失败":"Failed to load news"})}):0===s.length?(0,t.jsx)("div",{className:"flex flex-col items-center justify-center py-16 text-dark-400",children:(0,t.jsx)("p",{className:"text-lg",children:"zh"===e?"暂无资讯":"No news available"})}):(0,t.jsx)("div",{className:"space-y-3",children:s.map(e=>{let s=d===e.id,o=e.img?e.img.startsWith("http")?e.img:`https://sitehub.schg.xyz${e.img}`:null;return(0,t.jsxs)("div",{className:"rounded-xl border border-white/[0.06] bg-white/[0.03] overflow-hidden cursor-pointer hover:border-white/[0.12] transition-colors",onClick:()=>{var t;p(d===(t=e.id)?null:t)},children:[(0,t.jsxs)("div",{className:"flex items-start gap-3 p-4",children:[o&&(0,t.jsx)("div",{className:"shrink-0 w-20 h-14 rounded-lg overflow-hidden bg-white/[0.04]",children:(0,t.jsx)("img",{src:o,alt:"",className:"w-full h-full object-cover",loading:"lazy"})}),(0,t.jsxs)("div",{className:"min-w-0 flex-1",children:[(0,t.jsx)("h3",{className:`text-sm font-semibold text-dark-50 leading-snug ${s?"":"line-clamp-2"}`,children:e.title}),!s&&(0,t.jsx)("p",{className:"text-xs text-dark-400 mt-1.5 line-clamp-2 leading-relaxed",children:e.content?.replace(/<[^>]+>/g,"").slice(0,120)}),!s&&(0,t.jsxs)("div",{className:"mt-2 flex items-center gap-2 text-[11px] text-dark-500",children:[(0,t.jsx)("span",{children:e.source_name}),(0,t.jsx)("span",{children:"·"}),(0,t.jsx)("span",{children:e.created_at?.slice(0,10)})]})]}),(0,t.jsx)("svg",{className:`mt-1 h-4 w-4 shrink-0 text-dark-500 transition-transform ${s?"rotate-180":""}`,fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",strokeWidth:2,children:(0,t.jsx)("path",{d:"M19 9l-7 7-7-7"})})]}),s&&(0,t.jsxs)("div",{className:"border-t border-white/[0.06] px-4 pb-4 pt-3",children:[o&&(0,t.jsx)("div",{className:"mb-3 rounded-lg overflow-hidden bg-white/[0.04]",children:(0,t.jsx)("img",{src:o,alt:e.title,className:"w-full max-h-64 object-cover",loading:"lazy"})}),(0,t.jsx)("p",{className:"text-sm text-dark-300 leading-relaxed whitespace-pre-wrap",children:e.is_markdown?e.content:e.content?.replace(/<[^>]+>/g,"")}),(0,t.jsxs)("div",{className:"mt-3 flex items-center gap-2 text-[11px] text-dark-500",children:[(0,t.jsx)("span",{children:e.source_name}),(0,t.jsx)("span",{children:"·"}),(0,t.jsx)("span",{children:e.created_at?.slice(0,10)})]})]})]},e.id)})})}function d(){let{lang:e}=(0,o.useParams)(),d=(0,o.useSearchParams)().get("category"),p=(0,i.getDictionary)(e),m=(0,r.useMemo)(()=>d?"news"===d?[]:c.filter(e=>e.categoryKey===d):c,[d]);return(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)("h1",{className:"mb-6 text-2xl font-bold text-dark-50",children:p.article.title}),(0,t.jsxs)("div",{className:"mb-6 flex flex-wrap gap-2",children:[(0,t.jsx)(s.default,{href:`/${e}/articles`,className:`rounded-full px-3 py-1.5 text-xs font-medium transition-all ${!d?"bg-indigo-500/20 text-indigo-300 border border-indigo-500/30":"bg-white/[0.04] text-dark-300 border border-white/[0.06] hover:bg-white/[0.08] hover:text-dark-100"}`,children:p.article.allCategories}),n.map(o=>(0,t.jsx)(s.default,{href:`/${e}/articles?category=${o.key}`,className:`rounded-full px-3 py-1.5 text-xs font-medium transition-all ${d===o.key?"bg-indigo-500/20 text-indigo-300 border border-indigo-500/30":"bg-white/[0.04] text-dark-300 border border-white/[0.06] hover:bg-white/[0.08] hover:text-dark-100"}`,children:o.label[e]},o.key))]}),"news"===d?(0,t.jsx)(l,{lang:e}):m.length>0?(0,t.jsx)("div",{className:"grid gap-4 sm:grid-cols-2 lg:grid-cols-3",children:m.map(s=>(0,t.jsx)(a,{article:s,locale:e},s.slug))}):(0,t.jsxs)("div",{className:"flex flex-col items-center justify-center py-16 text-dark-400",children:[(0,t.jsx)("p",{className:"text-lg",children:"zh"===e?"该分类暂无文章":"No articles in this category"}),(0,t.jsx)(s.default,{href:`/${e}/articles`,className:"mt-2 text-sm text-indigo-400 hover:text-indigo-300",children:"zh"===e?"查看全部文章 →":"View all articles →"})]})]})}e.s(["default",0,function(){let{lang:e}=(0,o.useParams)(),a=(0,i.getDictionary)(e);return(0,t.jsxs)("div",{className:"mx-auto max-w-6xl px-4 py-8",children:[(0,t.jsxs)("nav",{className:"mb-6 text-sm text-dark-400",children:[(0,t.jsx)(s.default,{href:`/${e}`,className:"hover:text-dark-200 transition-colors",children:a.common.breadcrumb.home}),(0,t.jsx)("span",{className:"mx-2",children:"›"}),(0,t.jsx)("span",{className:"text-dark-200",children:a.nav.articles})]}),(0,t.jsx)(r.Suspense,{fallback:(0,t.jsx)("div",{className:"text-dark-400 py-8",children:"zh"===e?"加载中...":"Loading..."}),children:(0,t.jsx)(d,{})})]})}],9325)}]);