  ...
  return {
    ...
    keywords: 'Roman numeral converter, Roman numeral to number, Arabic to Roman, numeral converter, 罗马数字, 罗马数字转换, 阿拉伯数字转罗马数字, 罗马数字对照表',
      ...
      description: lang === 'zh'
        ...
        : 'Online Roman numeral converter. Convert between Arabic ...',
    },
    alternates: {
      languages: { 'zh': '/zh/tools/roman-numeral', 'en': '/en/tools/roman-numeral' },
      canonical: `https://schg.xyz/${lang}/tools/roman-numeral`,
    },
  }
}
