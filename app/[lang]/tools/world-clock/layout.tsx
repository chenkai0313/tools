  ...
  return {
    ...
    keywords: 'world clock, timezone converter, time zone map, UTC converter, world time, 世界时钟, 时区转换, 全球时间, 时差查询, UTC时间, 多城市时间',
      ...
      description: lang === 'zh'
        ...
        : 'Online world clock and timezone converter. Add multiple...',
    },
    alternates: {
      languages: { 'zh': '/zh/tools/world-clock', 'en': '/en/tools/world-clock' },
      canonical: `https://schg.xyz/${lang}/tools/world-clock`,
    },
  }
}
