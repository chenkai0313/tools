...
The tools mentioned in this article — JSON formatter, regex tester, config converter — are all available for free at [schg.xyz](https://schg.xyz). They run entirely in your browser. No uploads, no registration, no server-side processing. Just tools that work.`},{slug:"json-format-guide",title:"What is JSON? How to Format, Validate and Parse JSON Data",description:"Complete guide to JSON format: learn JSON syntax rules, common mistakes to avoid, how to format JSON in JavaScript/Python/Go, and best practices for API development.",category:"Frontend",categoryKey:"frontend",date:"2026-04-23",readTime:6,hot:!0,content:`## Why JSON Won
...
My rule of thumb: if the encoded data fits in a single HTTP response (under 1MB), Base64 is fine. For file uploads or streaming data, send raw binary with the correct Content-Type header instead.`},{slug:"cron-expression-guide",title:"Cron Expression Guide: Syntax, Examples and Common Schedules",description:"Complete cron expression tutorial covering 5-field syntax, special characters, common scheduling patterns, and real-world examples for Linux, Node.js and GitHub Actions.",category:"DevOps",categoryKey:"devops",date:"2026-04-25",readTime:6,content:`## What is a Cron Expression?
...
Cron is one of those Unix tools that looks simple on the surface but has enough edge cases to fill a book. Use absolute paths, log everything, and never assume your cron expression means what you think it does without testing it first with a cron expression parser.`},{slug:"ip-address-guide",title:"IP Address Basics: IPv4 vs IPv6, CIDR Notation and Subnetting",description:"Learn IP addressing fundamentals: IPv4 structure, IPv6 simplified notation, private address ranges, CIDR subnetting explained with examples for network configuration.",category:"DevOps",categoryKey:"devops",date:"2026-04-26",readTime:6,content:`## What is an IP Address?
...
The hash vs encryption distinction is not academic — choosing the wrong algorithm creates security holes. Hash for verification, encrypt for confidentiality, and use the right tool for each job.`},{slug:"docker-install-ubuntu",title:"How to Install Docker and Docker Compose on Ubuntu: Complete Guide",description:"Step-by-step guide to install Docker Engine and Docker Compose on Ubuntu. Includes registry mirror setup for China, proxy configuration, and post-installation tips.",category:"DevOps",categoryKey:"devops",date:"2026-04-28",readTime:6,hot:!0,content:`This guide covers installing Docker Engine and Docker Compose on Ubuntu. The official apt repository method described below is the approach I use on all my servers — it is the most maintainable long-term.
...
\`\`\`
Docker installation on Ubuntu is straightforward once you know the right steps. The key is using Docker's official apt repository rather than the version in Ubuntu's default repos — the default repos are often months behind, and with Docker, you want the latest security patches.`},{slug:"k3s-cluster-setup",title:"How to Set Up a K3s Kubernetes Cluster on Ubuntu: Step-by-Step",description:"Complete guide to deploying a K3s cluster on Ubuntu with system initialization, Docker configuration, NFS storage setup, and Helm installation for production workloads.",category:"DevOps",categoryKey:"devops",date:"2026-04-29",readTime:9,hot:!0,content:`This guide walks through setting up a K3s Kubernetes cluster on Ubuntu with 3 nodes: one master and two workers. K3s is a lightweight Kubernetes distribution designed for resource-constrained environments — it replaces the kubelet, containerd, and etcd with a single binary and embedded database.
...
DeepSeek offers GPT-4-class performance at a fraction of the cost. For developers building AI-powered tools, it is worth evaluating as either a primary or fallback model, especially for code generation and reasoning tasks.`},{slug:"deepseek-coding-tips",title:"How to Use DeepSeek for Programming: Tips for Code Generation and Debugging",description:"Practical DeepSeek coding tips for developers: prompt engineering strategies, code review workflows, multi-file context management, and common pitfalls to avoid.",category:"AI",categoryKey:"ai",date:"2026-05-03",readTime:6,content:`## AI-Assisted Programming Today
...
All great tools feel strange at first.`},{slug:"codex-claude-code-vs-cursor-comparison",title:"Codex CLI vs Claude Code vs Cursor: Which Ships Better Code?",description:"I tested Codex CLI, Claude Code, and Cursor on real projects for 6 months. Honest comparison of setup, workflow, debugging, and which tool wins your use case.",category:"AI",categoryKey:"ai",date:"2026-05-11",readTime:10,hot:!0,content:`## Why I Tested All Three
...
Me? I am keeping both Cursor and Claude Code open on my second monitor right now. They complement each other better than I expected.`}];function d({lang:e}){let[o,s]=(0,a.useState)([]),[n,r]=(0,a.useState)(!0),[i,l]=(0,a.useState)(!1),[c,h]=(0,a.useState)(null);return((0,a.useEffect)(()=>{let e=new AbortController;return fetch("https://sitehub.schg.xyz/api/v1/news/list?page=1&page_size=12",{signal:e.signal}).then(e=>e.json()).then(e=>{0===e.code&&e.data?.list&&s(e.data.list),r(!1)}).catch(e=>{"AbortError"!==e.name&&(l(!0),r(!1))}),()=>e.abort()},[]),n)?(0,t.jsx)("div",{className:"grid gap-4 sm:grid-cols-2 lg:grid-cols-3",children:[1,2,3,4,5,6].map(e=>(0,t.jsxs)("div",{className:"animate-pulse rounded-xl border border-white/[0.06] bg-white/[0.03] p-4",children:[(0,t.jsx)("div",{className:"mb-2 h-4 w-3/4 rounded bg-white/[0.06]"}),(0,t.jsx)("div",{className:"mb-3 h-3 w-1/2 rounded bg-white/[0.04]"}),(0,t.jsxs)("div",{className:"space-y-1.5",children:[(0,t.jsx)("div",{className:"h-3 w-full rounded bg-white/[0.04]"}),(0,t.jsx)("div",{className:"h-3 w-5/6 rounded bg-white/[0.04]"})]})]},e))}):i?(0,t.jsx)("div",{className:"flex flex-col items-center justify-center py-16 text-dark-400",children:(0,t.jsx)("p",{className:"text-lg",children:"zh"===e?"资讯加载失败":"Failed to load news"})}):0===o.length?(0,t.jsx)("div",{className:"flex flex-col items-center justify-center py-16 text-dark-400",children:(0,t.jsx)("p",{className:"text-lg",children:"zh"===e?"暂无资讯":"No news available"})}):(0,t.jsx)("div",{className:"space-y-3",children:o.map(e=>{let o=c===e.id;return(0,t.jsxs)("div",{className:"rounded-xl border border-white/[0.06] bg-white/[0.03] overflow-hidden cursor-pointer hover:border-white/[0.12] transition-colors",onClick:()=>{var t;h(c===(t=e.id)?null:t)},children:[(0,t.jsxs)("div",{className:"flex items-start gap-3 p-4",children:[(0,t.jsxs)("div",{className:"min-w-0 flex-1",children:[(0,t.jsx)("h3",{className:`text-sm font-semibold text-dark-50 leading-snug ${o?"":"line-clamp-2"}`,children:e.title}),!o&&(0,t.jsx)("p",{className:"text-xs text-dark-400 mt-1.5 line-clamp-2 leading-relaxed",children:e.content?.replace(/<[^>]+>/g,"").slice(0,120)}),!o&&(0,t.jsxs)("div",{className:"mt-2 flex items-center gap-2 text-[11px] text-dark-500",children:[(0,t.jsx)("span",{children:e.source_name}),(0,t.jsx)("span",{children:"·"}),(0,t.jsx)("span",{children:e.created_at?.slice(0,10)})]})]}),(0,t.jsx)("svg",{className:`mt-1 h-4 w-4 shrink-0 text-dark-500 transition-transform ${o?"rotate-180":""}`,fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",strokeWidth:2,children:(0,t.jsx)("path",{d:"M19 9l-7 7-7-7"})})]}),o&&(0,t.jsxs)("div",{className:"border-t border-white/[0.06] px-4 pb-4 pt-3",children:[(0,t.jsx)("p",{className:"text-sm text-dark-300 leading-relaxed whitespace-pre-wrap",children:e.is_markdown?e.content:e.content?.replace(/<[^>]+>/g,"")}),(0,t.jsxs)("div",{className:"mt-3 flex items-center gap-2 text-[11px] text-dark-500",children:[(0,t.jsx)("span",{children:e.source_name}),(0,t.jsx)("span",{children:"·"}),(0,t.jsx)("span",{children:e.created_at?.slice(0,10)})]})]})]},e.id)})})}function c(){let{lang:e}=(0,s.useParams)(),c=(0,s.useSearchParams)().get("category"),h=(0,r.getDictionary)(e),u=(0,a.useMemo)(()=>c?"news"===c?[]:l.filter(e=>e.categoryKey===c):l,[c]);return(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)("h1",{className:"mb-6 text-2xl font-bold text-dark-50",children:h.article.title}),(0,t.jsxs)("div",{className:"mb-6 flex flex-wrap gap-2",children:[(0,t.jsx)(o.default,{href:`/${e}/articles`,className:`rounded-full px-3 py-1.5 text-xs font-medium transition-all ${!c?"bg-indigo-500/20 text-indigo-300 border border-indigo-500/30":"bg-white/[0.04] text-dark-300 border border-white/[0.06] hover:bg-white/[0.08] hover:text-dark-100"}`,children:h.article.allCategories}),i.map(s=>(0,t.jsx)(o.default,{href:`/${e}/articles?category=${s.key}`,className:`rounded-full px-3 py-1.5 text-xs font-medium transition-all ${c===s.key?"bg-indigo-500/20 text-indigo-300 border border-indigo-500/30":"bg-white/[0.04] text-dark-300 border border-white/[0.06] hover:bg-white/[0.08] hover:text-dark-100"}`,children:s.label[e]},s.key))]}),"news"===c?(0,t.jsx)(d,{lang:e}):u.length>0?(0,t.jsx)("div",{className:"grid gap-4 sm:grid-cols-2 lg:grid-cols-3",children:u.map(o=>(0,t.jsx)(n,{article:o,locale:e},o.slug))}):(0,t.jsxs)("div",{className:"flex flex-col items-center justify-center py-16 text-dark-400",children:[(0,t.jsx)("p",{className:"text-lg",children:"zh"===e?"该分类暂无文章":"No articles in this category"}),(0,t.jsx)(o.default,{href:`/${e}/articles`,className:"mt-2 text-sm text-indigo-400 hover:text-indigo-300",children:"zh"===e?"查看全部文章 →":"View all articles →"})]})]})}e.s(["default",0,function(){let{lang:e}=(0,s.useParams)(),n=(0,r.getDictionary)(e);return(0,t.jsxs)("div",{className:"mx-auto max-w-6xl px-4 py-8",children:[(0,t.jsxs)("nav",{className:"mb-6 text-sm text-dark-400",children:[(0,t.jsx)(o.default,{href:`/${e}`,className:"hover:text-dark-200 transition-colors",children:n.common.breadcrumb.home}),(0,t.jsx)("span",{className:"mx-2",children:"›"}),(0,t.jsx)("span",{className:"text-dark-200",children:n.nav.articles})]}),(0,t.jsx)(a.Suspense,{fallback:(0,t.jsx)("div",{className:"text-dark-400 py-8",children:"zh"===e?"加载中...":"Loading..."}),children:(0,t.jsx)(c,{})})]})}],9325)}]);